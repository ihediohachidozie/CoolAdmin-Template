<header class="header-desktop4">
        ...
        <a href="#">
        <img src="{{ asset('theme/images/icon/logo-blue.png')}}" alt="CoolAdmin" />
        </a>
        </div>
        ...
        <span class="email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8fe5e0e7e1ebe0eacfeaf7eee2ffe3eaa1ece0e2">[email&#160;protected]</a></span>
        </div>
        </div>
        <div class="account-dropdown__body">
        <div class="account-dropdown__item">
